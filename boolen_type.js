...
//3. True равен 1, а если у нас осталась 1 после применения остатка от деления %, то значит число не четное.
/*
4. Таким образом когда мы проверяем на четность и не четность, то 7 % 2 без сравнения == 0, */
...
// if(7 % 2){   //даем условие, что 7 это не четнео число
//   console.log(true);
// } else {
//   console.log(false);
// }
